...
cronwrap will delay for a random amount of time up to a specified
...
cronwrap will not start multiple simultaneous copies of job. For
...
cronwrap will terminate the process if it runs longer than the
...
cronwrap will suppress non-zero exit values and output unless the
